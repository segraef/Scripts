...
$organization = "prefix" # Read-Host "Azure DevOps Organization Name"
$Env:AZP_URL = "https://dev.azure.com/$organization/"
$Env:AZP_TOKEN = "" # Read-Host "Azure DevOps Personal Access Token"
$Env:AZP_POOL= "prefix-NonProd-WindowsPool-001" # Read-Host "Azure DevOps Agent Pool " #
# $Env:AZP_CLEANUP = "true"
...
## PowerShell 7
# if (-not $Host.version.Major -lt 7) {
